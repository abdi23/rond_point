  ...
  $.extend(true,$.summernote.lang, {
    'en-US': { /* English */
      videoAttributes: {
        ...
        autoplay: 'Autoplay',
        loop: 'Loop',
        note: '<strong>Video URL</strong> <small>(YouTube, Vimeo, Vine, Instagram, DailyMotion or Youku)</small><br><i><small>Note: Not all options are available with all services...</small></i>',
        ok: 'Insert Video'
      }
    }
  });
